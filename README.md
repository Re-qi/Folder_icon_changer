...
## 项目简介
一款简洁实用的Windows文件夹图标修改工具，内置原创简易图标设计器，可直接制作、编辑自定义文件夹图标。
整体界面布局参考优秀开源项目思路重构，**在相似交互逻辑下全面优化底层运行逻辑**，大幅降低内存与CPU占用，运行更轻快，完美适配低配置电脑使用。
...
2. **内置图标素材**
软件自带全套精美文件夹图标资源均来源于：**Folder11** 开源项目
[Folder11-ico](https://github.com/icon11-community/Folder11-ico)

4. **原创内置工具**
本人独立开发简易图标设计器集成至本软件，可快速自制专属图标

## 项目特色
- 轻量化优化，占用资源极少，老旧低配电脑无压力流畅使用
- 沿用简洁易懂操作布局，上手零学习成本
- 内置原创图标设计器，无需额外软件即可自制图标
- 支持一键更换文件夹图标、一键恢复默认图标
- 运行响应更快，加载速度优于同类同布局工具
